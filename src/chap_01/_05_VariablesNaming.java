...
public class _05_VariablesNaming {
    public static void main(String[] args) {
        // 변수 이름 짓는 법
        // 1. 저장할 값에 어울리는 이름
        // 2. 밑줄(__), 문자(abc), 숫자(123_ 사용 가능 (공백 사용 불가)
        // 3. 밑줄 또는 문자로 시작 가능
        ...
        String residentialAddress = "띠용 호텔"; //체류지
        String purposeOfVisit = "관광"; //입국 목적
        String flightNo = "AE652"; //항공편 명
        String _flightNo = "AE652"; // 밑줄 시작
        String flight_no_2 = "AE652"; // 밑줄과 숫자 포함
        // string -flightNo = "AE652";
